  ...
  return (
    <div className=" grid grid-cols-2 p-32 py-20 h-screen w-screen bg-BgDarkBlue " id="product">
        <div className="relative flex flex-row ">
            ...
            <img src="./src/assets/ProdutoEx.jpg" alt="Pessoas analisando quadro de gestão organizacional de projetos" className="h-3/5 relative z-10 drop-shadow-right-bottom"/>
        </div>
